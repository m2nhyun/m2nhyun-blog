    ...
    if (posts.length === 0) {
        return (
            <div className="text-center py-12">
                ...
                <Link
                    href="/admin"
                    className="inline-block px-6 py-3 bg-gray-900 dark:bg-gray-100 text-white rounded-md hover:bg-gray-800 dark:hover:bg-gray-200 dark:text-gray-900 transition-colors"
                >
                    포스트 작성하기
                </Link>
            </div>
                ...
                <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                        <Link href={`/blog/${post.slug}`}>
                            <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
                                {post.title}
                            </h2>
                        </Link>
                        {post.featured && (
